        ...
        <div className="row">
          <div className="xl:w-1/2">
            <article className="text-white relative text-center">
              ...
              <a href="/careers/" className="block xl:inline-block bg-secondary text-white hover:bg-white hover:text-secondary transition-all text-lg font-bold rounded-full px-12 py-4">Apply Now</a>
            </article>
          </div>
        </div>
      </div>
