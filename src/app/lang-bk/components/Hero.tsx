...
export default function Hero({ data }: HeroProps) {
  ...
  const [loanPurpose, setLoanPurpose] = useState("CONSUMER");
  ...
  const handleLoanTypeClick = (type: string) => {
    setLoanType(type);
    if (type === "CAR_LOAN") {
      nextStep();
    } else {
      setLoanPurpose("CONSUMER");
      setStep(3);
    }
  };

  const handleLoanPurposeClick = (purpose: string) => {
  ...
  const handleSubmit = () => {
    ...
    // console.log(loanType,loanPurpose,loanAmount,loanTerm);
    setQuote(prevQuote => ({
      ...prevQuote,
      type: loanType,
      usage: loanPurpose,
                ...
                {step === 1 && (
                  <>
                    <HighlightedText
                      ...
                      tag="p"
                      className="text-2xl md:text-4xl font-bold mt-6 md:mt-0 mb-6"
                    />
                    <div className="flex flex-wrap md:flex-nowrap -m-2">
                      <div className="w-1/2 md:w-full p-2">
                        <button
                          onClick={() => handleLoanTypeClick("CAR_LOAN")}
                      ...
                      <div className="w-1/2 md:w-full p-2">
                        <button
                          onClick={() => handleLoanTypeClick("EQUIPMENT_LOAN")}
                          className="w-full group text-center pt-3 md:pt-5 rounded-xl bg-opacity-25 hover:bg-opacity-100 hover:scale-105 transition-all duration-500 bg-lightpurple text-primary"
                        >
                          {equipment && (
                            <Image
                      ...
                      <div className="w-1/2 md:w-full p-2">
                        <button
                          onClick={() => handleLoanTypeClick("PERSONAL_LOAN")}
                          className="w-full group text-center pt-3 md:pt-5 rounded-xl bg-opacity-25 hover:bg-opacity-100 hover:scale-105 transition-all duration-500 bg-lightpurple text-primary"
                        >
                          {personal && (
                            <Image
                      ...
                      <div className="w-1/2 md:w-full p-2">
                        <button
                          onClick={() => handleLoanTypeClick("BUSINESS_LOAN")}
                          className="w-full group text-center pt-3 md:pt-5 rounded-xl bg-opacity-25 hover:bg-opacity-100 hover:scale-105 transition-all duration-500 bg-lightpurple text-primary"
                        >
                          {business && (
                            <Image
                  ...
                  <>
                    ...
                    <div className="flex flex-wrap md:flex-nowrap -m-2">
                      <div className="w-1/2 md:w-1/4 p-2">
                        <button
                          onClick={() => handleLoanPurposeClick("CONSUMER")}
                          className="w-full group text-center pt-3 md:pt-5 rounded-xl bg-opacity-25 hover:bg-opacity-100 hover:scale-105 transition-all duration-500 bg-lightpurple text-primary"
                        >
                          {personal && (
                            <Image
                      ...
                      <div className="w-1/2 md:w-1/4 p-2">
                        <button
                          onClick={() => handleLoanPurposeClick("COMMERCIAL")}
                          className="w-full group text-center pt-3 md:pt-5 rounded-xl bg-opacity-25 hover:bg-opacity-100 hover:scale-105 transition-all duration-500 bg-lightpurple text-primary"
                        >
                          {business && (
                            <Image
                    ...
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, #5614bb ${
                          ((loanAmount - 5000) / 495000) * 100
                        }%, #D3D3D3 ${((loanAmount - 5000) / 495000) * 100}%)`,
                        appearance: "none",
                        height: "25px",
                        borderRadius: "50rem",
                      }}
                ...
                {step === 4 && (
                  <>
                    ...
                    <input
                      ...
                      value={loanTerm}
                      onChange={(e) =>
                        handleLoanTermChange(Number(e.target.value))
                      }
                      className="w-full mb-6"
                      style={{
                        background: `linear-gradient(to right, #5614bb ${
                          ((loanTerm - 1) / 6) * 100
                        }%, #D3D3D3 ${((loanTerm - 1) / 6) * 100}%)`,
                        appearance: "none",
                        height: "25px",
                        borderRadius: "50rem",
                      }}
